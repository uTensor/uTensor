...
def gen_arithmatic(num_tests=10):
    tests = []
    const_snippets = []
    test_dir_path = (
    ...
    with (test_dir_path / "constants_arithmetic.hpp").open("w") as fp:
    ...
    with (test_dir_path / "test_arithmetic.cpp").open("w") as fp:
