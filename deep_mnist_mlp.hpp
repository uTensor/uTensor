...
int runMLP(string inputIdxFile) {
  ...
  Tensor* w2 = t_import.ubyte_import(
      "/fs/testData/deep_mlp/runPredLayer/MatMul_2_eightbit_quantized_mat_mul/"
      "inputs/Variable_4_quint8_const_0.idx");
  Tensor* w2_min = t_import.float_import(
      "/fs/testData/deep_mlp/runPredLayer/MatMul_2_eightbit_quantized_mat_mul/"
      "inputs/Variable_4_min_0.idx");
  Tensor* w2_max = t_import.float_import(
      "/fs/testData/deep_mlp/runPredLayer/MatMul_2_eightbit_quantized_mat_mul/"
  ...
  Tensor* pred = nullptr;
  PredLayer<unsigned char, float, int>(relu_output2, relu_min2, relu_max2, &pred, w2, w2_min, w2_max, bias, dim);
