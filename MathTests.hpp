...
public:
    void requantization_rangeTest(void) {
        ...
        //reference outputs
        Tensor<float> ref_min = t_import.float_import("/fs/testData/rqRange/out/rqRange_0.idx");
        Tensor<float> ref_max = t_import.float_import("/fs/testData/rqRange/out/rqRange_1.idx");
    ...
    void requantizeTest(void) {
        ...
        //reference outputs
        Tensor<unsigned char> ref_a_q = t_import.ubyte_import("/fs/testData/rQ/out/rQ_0.idx");
        Tensor<float> ref_a_min = t_import.float_import("/fs/testData/rQ/out/rQ_1.idx");
        Tensor<float> ref_a_max = t_import.float_import("/fs/testData/rQ/out/rQ_2.idx");
        ...
        double result = meanPercentErr(ref_a_q, a_q) + meanPercentErr(ref_a_min, a_min_q) + meanPercentErr(ref_a_max, a_max_q);
        //passed(result < 0.0001);
        passed(result == 0);
    }
    ...
    void argmaxTest(void) {  //NT: WIP   do not use t_import int 64 here
        ...
        //reference inputs
        Tensor<float> ref_a = t_import.float_import("/fs/testData/ref_argmax/in/Const_2_0.idx");
    ...
    void addTest(void) {
        ...
        //reference inputs
        Tensor<float> a = t_import.float_import("/fs/testData/ref_add/in/Const_5_0.idx");
        Tensor<float> b = t_import.float_import("/fs/testData/ref_add/in/Const_6_0.idx");

        //reference outputs
        Tensor<float> ref_out = t_import.float_import("/fs/testData/ref_add/out/ref_add_0.idx");
