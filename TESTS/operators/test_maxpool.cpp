...
TEST(MaxPool, random_inputs_VALID_0_kh_1_kw_1_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_0_kh_1_kw_1_stride_1);
  Tensor out = new RamTensor({1, 28, 28, 3}, flt);

  MaxPoolOperator<float> mxpool({1, 1}, {1, 1, 1, 1}, VALID);
  mxpool.set_inputs({{MaxPoolOperator<float>::in, in}})
      .set_outputs({{MaxPoolOperator<float>::out, out}})
      .eval();
...
TEST(MaxPool, random_inputs_VALID_0_kh_1_kw_1_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_0_kh_1_kw_1_stride_2);
...
TEST(MaxPool, random_inputs_VALID_0_kh_1_kw_3_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_0_kh_1_kw_3_stride_1);
...
TEST(MaxPool, random_inputs_VALID_0_kh_1_kw_3_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_0_kh_1_kw_3_stride_2);
...
TEST(MaxPool, random_inputs_VALID_0_kh_1_kw_5_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_0_kh_1_kw_5_stride_1);
...
TEST(MaxPool, random_inputs_VALID_0_kh_1_kw_5_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_0_kh_1_kw_5_stride_2);
...
TEST(MaxPool, random_inputs_VALID_0_kh_3_kw_1_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_0_kh_3_kw_1_stride_1);
...
TEST(MaxPool, random_inputs_VALID_0_kh_3_kw_1_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_0_kh_3_kw_1_stride_2);
...
TEST(MaxPool, random_inputs_VALID_0_kh_3_kw_3_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_0_kh_3_kw_3_stride_1);
...
TEST(MaxPool, random_inputs_VALID_0_kh_3_kw_3_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_0_kh_3_kw_3_stride_2);
...
TEST(MaxPool, random_inputs_VALID_0_kh_3_kw_5_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_0_kh_3_kw_5_stride_1);
...
TEST(MaxPool, random_inputs_VALID_0_kh_3_kw_5_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_0_kh_3_kw_5_stride_2);
...
TEST(MaxPool, random_inputs_VALID_0_kh_5_kw_1_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_0_kh_5_kw_1_stride_1);
...
TEST(MaxPool, random_inputs_VALID_0_kh_5_kw_1_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_0_kh_5_kw_1_stride_2);
...
TEST(MaxPool, random_inputs_VALID_0_kh_5_kw_3_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_0_kh_5_kw_3_stride_1);
...
TEST(MaxPool, random_inputs_VALID_0_kh_5_kw_3_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_0_kh_5_kw_3_stride_2);
...
TEST(MaxPool, random_inputs_VALID_0_kh_5_kw_5_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_0_kh_5_kw_5_stride_1);
...
TEST(MaxPool, random_inputs_VALID_0_kh_5_kw_5_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_0_kh_5_kw_5_stride_2);
...
TEST(MaxPool, random_inputs_VALID_1_kh_1_kw_1_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_1_kh_1_kw_1_stride_1);
  Tensor out = new RamTensor({1, 28, 28, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_1_kh_1_kw_1_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_1_kh_1_kw_1_stride_2);
  Tensor out = new RamTensor({1, 14, 14, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_1_kh_1_kw_3_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_1_kh_1_kw_3_stride_1);
  Tensor out = new RamTensor({1, 28, 26, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_1_kh_1_kw_3_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_1_kh_1_kw_3_stride_2);
  Tensor out = new RamTensor({1, 14, 13, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_1_kh_1_kw_5_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_1_kh_1_kw_5_stride_1);
  Tensor out = new RamTensor({1, 28, 24, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_1_kh_1_kw_5_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_1_kh_1_kw_5_stride_2);
  Tensor out = new RamTensor({1, 14, 12, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_1_kh_3_kw_1_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_1_kh_3_kw_1_stride_1);
  Tensor out = new RamTensor({1, 26, 28, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_1_kh_3_kw_1_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_1_kh_3_kw_1_stride_2);
  Tensor out = new RamTensor({1, 13, 14, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_1_kh_3_kw_3_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_1_kh_3_kw_3_stride_1);
  Tensor out = new RamTensor({1, 26, 26, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_1_kh_3_kw_3_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_1_kh_3_kw_3_stride_2);
  Tensor out = new RamTensor({1, 13, 13, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_1_kh_3_kw_5_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_1_kh_3_kw_5_stride_1);
  Tensor out = new RamTensor({1, 26, 24, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_1_kh_3_kw_5_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_1_kh_3_kw_5_stride_2);
  Tensor out = new RamTensor({1, 13, 12, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_1_kh_5_kw_1_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_1_kh_5_kw_1_stride_1);
  Tensor out = new RamTensor({1, 24, 28, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_1_kh_5_kw_1_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_1_kh_5_kw_1_stride_2);
  Tensor out = new RamTensor({1, 12, 14, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_1_kh_5_kw_3_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_1_kh_5_kw_3_stride_1);
  Tensor out = new RamTensor({1, 24, 26, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_1_kh_5_kw_3_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_1_kh_5_kw_3_stride_2);
  Tensor out = new RamTensor({1, 12, 13, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_1_kh_5_kw_5_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_1_kh_5_kw_5_stride_1);
  Tensor out = new RamTensor({1, 24, 24, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_1_kh_5_kw_5_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_1_kh_5_kw_5_stride_2);
  Tensor out = new RamTensor({1, 12, 12, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_2_kh_1_kw_1_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_2_kh_1_kw_1_stride_1);
  Tensor out = new RamTensor({1, 28, 28, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_2_kh_1_kw_1_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_2_kh_1_kw_1_stride_2);
  Tensor out = new RamTensor({1, 14, 14, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_2_kh_1_kw_3_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_2_kh_1_kw_3_stride_1);
  Tensor out = new RamTensor({1, 28, 26, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_2_kh_1_kw_3_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_2_kh_1_kw_3_stride_2);
  Tensor out = new RamTensor({1, 14, 13, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_2_kh_1_kw_5_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_2_kh_1_kw_5_stride_1);
  Tensor out = new RamTensor({1, 28, 24, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_2_kh_1_kw_5_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_2_kh_1_kw_5_stride_2);
  Tensor out = new RamTensor({1, 14, 12, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_2_kh_3_kw_1_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_2_kh_3_kw_1_stride_1);
  Tensor out = new RamTensor({1, 26, 28, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_2_kh_3_kw_1_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_2_kh_3_kw_1_stride_2);
  Tensor out = new RamTensor({1, 13, 14, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_2_kh_3_kw_3_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_2_kh_3_kw_3_stride_1);
  Tensor out = new RamTensor({1, 26, 26, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_2_kh_3_kw_3_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_2_kh_3_kw_3_stride_2);
  Tensor out = new RamTensor({1, 13, 13, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_2_kh_3_kw_5_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_2_kh_3_kw_5_stride_1);
  Tensor out = new RamTensor({1, 26, 24, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_2_kh_3_kw_5_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_2_kh_3_kw_5_stride_2);
  Tensor out = new RamTensor({1, 13, 12, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_2_kh_5_kw_1_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_2_kh_5_kw_1_stride_1);
  Tensor out = new RamTensor({1, 24, 28, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_2_kh_5_kw_1_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_2_kh_5_kw_1_stride_2);
  Tensor out = new RamTensor({1, 12, 14, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_2_kh_5_kw_3_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_2_kh_5_kw_3_stride_1);
  Tensor out = new RamTensor({1, 24, 26, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_2_kh_5_kw_3_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_2_kh_5_kw_3_stride_2);
  Tensor out = new RamTensor({1, 12, 13, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_2_kh_5_kw_5_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_2_kh_5_kw_5_stride_1);
  Tensor out = new RamTensor({1, 24, 24, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_2_kh_5_kw_5_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_2_kh_5_kw_5_stride_2);
  Tensor out = new RamTensor({1, 12, 12, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_3_kh_1_kw_1_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_3_kh_1_kw_1_stride_1);
  Tensor out = new RamTensor({1, 28, 28, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_3_kh_1_kw_1_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_3_kh_1_kw_1_stride_2);
  Tensor out = new RamTensor({1, 14, 14, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_3_kh_1_kw_3_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_3_kh_1_kw_3_stride_1);
  Tensor out = new RamTensor({1, 28, 26, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_3_kh_1_kw_3_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_3_kh_1_kw_3_stride_2);
  Tensor out = new RamTensor({1, 14, 13, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_3_kh_1_kw_5_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_3_kh_1_kw_5_stride_1);
  Tensor out = new RamTensor({1, 28, 24, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_3_kh_1_kw_5_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_3_kh_1_kw_5_stride_2);
  Tensor out = new RamTensor({1, 14, 12, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_3_kh_3_kw_1_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_3_kh_3_kw_1_stride_1);
  Tensor out = new RamTensor({1, 26, 28, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_3_kh_3_kw_1_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_3_kh_3_kw_1_stride_2);
  Tensor out = new RamTensor({1, 13, 14, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_3_kh_3_kw_3_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_3_kh_3_kw_3_stride_1);
  Tensor out = new RamTensor({1, 26, 26, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_3_kh_3_kw_3_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_3_kh_3_kw_3_stride_2);
  Tensor out = new RamTensor({1, 13, 13, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_3_kh_3_kw_5_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_3_kh_3_kw_5_stride_1);
  Tensor out = new RamTensor({1, 26, 24, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_3_kh_3_kw_5_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_3_kh_3_kw_5_stride_2);
  Tensor out = new RamTensor({1, 13, 12, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_3_kh_5_kw_1_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_3_kh_5_kw_1_stride_1);
  Tensor out = new RamTensor({1, 24, 28, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_3_kh_5_kw_1_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_3_kh_5_kw_1_stride_2);
  Tensor out = new RamTensor({1, 12, 14, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_3_kh_5_kw_3_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_3_kh_5_kw_3_stride_1);
  Tensor out = new RamTensor({1, 24, 26, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_3_kh_5_kw_3_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_3_kh_5_kw_3_stride_2);
  Tensor out = new RamTensor({1, 12, 13, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_3_kh_5_kw_5_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_3_kh_5_kw_5_stride_1);
  Tensor out = new RamTensor({1, 24, 24, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_3_kh_5_kw_5_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_3_kh_5_kw_5_stride_2);
  Tensor out = new RamTensor({1, 12, 12, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_4_kh_1_kw_1_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_4_kh_1_kw_1_stride_1);
  Tensor out = new RamTensor({1, 28, 28, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_4_kh_1_kw_1_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_4_kh_1_kw_1_stride_2);
  Tensor out = new RamTensor({1, 14, 14, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_4_kh_1_kw_3_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_4_kh_1_kw_3_stride_1);
  Tensor out = new RamTensor({1, 28, 26, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_4_kh_1_kw_3_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_4_kh_1_kw_3_stride_2);
  Tensor out = new RamTensor({1, 14, 13, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_4_kh_1_kw_5_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_4_kh_1_kw_5_stride_1);
  Tensor out = new RamTensor({1, 28, 24, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_4_kh_1_kw_5_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_4_kh_1_kw_5_stride_2);
  Tensor out = new RamTensor({1, 14, 12, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_4_kh_3_kw_1_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_4_kh_3_kw_1_stride_1);
  Tensor out = new RamTensor({1, 26, 28, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_4_kh_3_kw_1_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_4_kh_3_kw_1_stride_2);
  Tensor out = new RamTensor({1, 13, 14, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_4_kh_3_kw_3_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_4_kh_3_kw_3_stride_1);
  Tensor out = new RamTensor({1, 26, 26, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_4_kh_3_kw_3_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_4_kh_3_kw_3_stride_2);
  Tensor out = new RamTensor({1, 13, 13, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_4_kh_3_kw_5_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_4_kh_3_kw_5_stride_1);
  Tensor out = new RamTensor({1, 26, 24, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_4_kh_3_kw_5_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_4_kh_3_kw_5_stride_2);
  Tensor out = new RamTensor({1, 13, 12, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_4_kh_5_kw_1_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_4_kh_5_kw_1_stride_1);
  Tensor out = new RamTensor({1, 24, 28, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_4_kh_5_kw_1_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_4_kh_5_kw_1_stride_2);
  Tensor out = new RamTensor({1, 12, 14, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_4_kh_5_kw_3_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_4_kh_5_kw_3_stride_1);
  Tensor out = new RamTensor({1, 24, 26, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_4_kh_5_kw_3_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_4_kh_5_kw_3_stride_2);
  Tensor out = new RamTensor({1, 12, 13, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_4_kh_5_kw_5_stride_1) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_4_kh_5_kw_5_stride_1);
  Tensor out = new RamTensor({1, 24, 24, 3}, flt);
...
TEST(MaxPool, random_inputs_VALID_4_kh_5_kw_5_stride_2) {
  ...
  Tensor in =
      new RomTensor({1, 28, 28, 3}, flt, s_in_VALID_4_kh_5_kw_5_stride_2);
  Tensor out = new RamTensor({1, 12, 12, 3}, flt);
