...
TEST(Logistic, random_gen_logistic__0_f) {
  ...
  uTensor::ReferenceOperators::LogisticOperator<float> logisticOp;
  logisticOp
  .set_inputs({ 
    { uTensor::ReferenceOperators::LogisticOperator<float>::in, in }
  }).set_outputs({ 
    { uTensor::ReferenceOperators::LogisticOperator<float>::out, out }
  }).eval();
...
TEST(Logistic, random_gen_logistic__0_q) {
  ...
  uTensor::ReferenceOperators::LogisticOperator<int8_t> logisticOp;
  logisticOp
  .set_inputs({ 
    { uTensor::ReferenceOperators::LogisticOperator<int8_t>::in, in }
  }).set_outputs({ 
    { uTensor::ReferenceOperators::LogisticOperator<int8_t>::out, out }
  }).eval();
