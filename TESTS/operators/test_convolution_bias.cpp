...
#include "constants_convolution_bias.hpp"
using std::cout;
using std::endl;
...
TEST(ConvolutionBias, random_inputs_SAME_0_stride_1) {
  ...
  Tensor b = new RomTensor({ 32 }, flt, s_b_SAME_0_stride_1);
  Tensor out = new RamTensor({ 1,28,28,32 }, flt);

  Conv2dOperator<float> conv_Aw({ 1,1,1,1}, SAME);
  conv_Aw
     .set_inputs({ {Conv2dOperator<float>::in, in}, {Conv2dOperator<float>::filter, w}, {Conv2dOperator<float>::bias, b} })
...
TEST(ConvolutionBias, random_inputs_SAME_0_stride_2) {
  localCircularArenaAllocator<1024> meta_allocator;
  ...
  Tensor b = new RomTensor({ 32 }, flt, s_b_SAME_0_stride_2);
...
TEST(ConvolutionBias, random_inputs_SAME_1_stride_1) {
  localCircularArenaAllocator<1024> meta_allocator;
  localCircularArenaAllocator<25088*2*sizeof(float), uint32_t> ram_allocator;
  Context::get_default_context()->set_metadata_allocator(&meta_allocator);
  Context::get_default_context()->set_ram_data_allocator(&ram_allocator);
  ...
  Tensor b = new RomTensor({ 32 }, flt, s_b_SAME_1_stride_1);
  Tensor out = new RamTensor({ 1,28,28,32 }, flt);
...
TEST(ConvolutionBias, random_inputs_SAME_1_stride_2) {
  localCircularArenaAllocator<1024> meta_allocator;
  localCircularArenaAllocator<6272*2*sizeof(float), uint32_t> ram_allocator;
  Context::get_default_context()->set_metadata_allocator(&meta_allocator);
  Context::get_default_context()->set_ram_data_allocator(&ram_allocator);
  ...
  Tensor b = new RomTensor({ 32 }, flt, s_b_SAME_1_stride_2);
  Tensor out = new RamTensor({ 1,14,14,32 }, flt);
...
TEST(ConvolutionBias, random_inputs_SAME_2_stride_1) {
  localCircularArenaAllocator<1024> meta_allocator;
  localCircularArenaAllocator<25088*2*sizeof(float), uint32_t> ram_allocator;
  Context::get_default_context()->set_metadata_allocator(&meta_allocator);
  Context::get_default_context()->set_ram_data_allocator(&ram_allocator);
  ...
  Tensor b = new RomTensor({ 32 }, flt, s_b_SAME_2_stride_1);
  Tensor out = new RamTensor({ 1,28,28,32 }, flt);
...
TEST(ConvolutionBias, random_inputs_SAME_2_stride_2) {
  localCircularArenaAllocator<1024> meta_allocator;
  localCircularArenaAllocator<6272*2*sizeof(float), uint32_t> ram_allocator;
  Context::get_default_context()->set_metadata_allocator(&meta_allocator);
  Context::get_default_context()->set_ram_data_allocator(&ram_allocator);
  ...
  Tensor b = new RomTensor({ 32 }, flt, s_b_SAME_2_stride_2);
  Tensor out = new RamTensor({ 1,14,14,32 }, flt);
...
TEST(ConvolutionBias, random_inputs_VALID_0_stride_1) {
  localCircularArenaAllocator<1024> meta_allocator;
  ...
  Tensor b = new RomTensor({ 32 }, flt, s_b_VALID_0_stride_1);
...
TEST(ConvolutionBias, random_inputs_VALID_0_stride_2) {
  localCircularArenaAllocator<1024> meta_allocator;
  ...
  Tensor b = new RomTensor({ 32 }, flt, s_b_VALID_0_stride_2);
...
TEST(ConvolutionBias, random_inputs_VALID_1_stride_1) {
  localCircularArenaAllocator<1024> meta_allocator;
  localCircularArenaAllocator<18432*2*sizeof(float), uint32_t> ram_allocator;
  Context::get_default_context()->set_metadata_allocator(&meta_allocator);
  Context::get_default_context()->set_ram_data_allocator(&ram_allocator);
  ...
  Tensor b = new RomTensor({ 32 }, flt, s_b_VALID_1_stride_1);
  Tensor out = new RamTensor({ 1,24,24,32 }, flt);
...
TEST(ConvolutionBias, random_inputs_VALID_1_stride_2) {
  localCircularArenaAllocator<1024> meta_allocator;
  localCircularArenaAllocator<4608*2*sizeof(float), uint32_t> ram_allocator;
  Context::get_default_context()->set_metadata_allocator(&meta_allocator);
  Context::get_default_context()->set_ram_data_allocator(&ram_allocator);
  ...
  Tensor b = new RomTensor({ 32 }, flt, s_b_VALID_1_stride_2);
  Tensor out = new RamTensor({ 1,12,12,32 }, flt);
...
TEST(ConvolutionBias, random_inputs_VALID_2_stride_1) {
  localCircularArenaAllocator<1024> meta_allocator;
  localCircularArenaAllocator<18432*2*sizeof(float), uint32_t> ram_allocator;
  Context::get_default_context()->set_metadata_allocator(&meta_allocator);
  Context::get_default_context()->set_ram_data_allocator(&ram_allocator);
  ...
  Tensor b = new RomTensor({ 32 }, flt, s_b_VALID_2_stride_1);
  Tensor out = new RamTensor({ 1,24,24,32 }, flt);
...
TEST(ConvolutionBias, random_inputs_VALID_2_stride_2) {
  localCircularArenaAllocator<1024> meta_allocator;
  localCircularArenaAllocator<4608*2*sizeof(float), uint32_t> ram_allocator;
  Context::get_default_context()->set_metadata_allocator(&meta_allocator);
  Context::get_default_context()->set_ram_data_allocator(&ram_allocator);
  ...
  Tensor b = new RomTensor({ 32 }, flt, s_b_VALID_2_stride_2);
  Tensor out = new RamTensor({ 1,12,12,32 }, flt);
