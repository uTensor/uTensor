...
TEST(Squeeze, random_inputs_float_0) {
  ...
  Squeeze.set_inputs({{SqueezeOperator<float>::x, io}}).eval();
...
TEST(Squeeze, random_inputs_int8_t_0) {
  ...
  Squeeze.set_inputs({{SqueezeOperator<int8_t>::x, io}}).eval();
...
TEST(Squeeze, random_inputs_int16_t_0) {
  ...
  Squeeze.set_inputs({{SqueezeOperator<int16_t>::x, io}}).eval();
...
TEST(Squeeze, random_inputs_int32_t_0) {
  ...
  Squeeze.set_inputs({{SqueezeOperator<int32_t>::x, io}}).eval();
