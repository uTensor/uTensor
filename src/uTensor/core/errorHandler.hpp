...
// Compile time hash borrowed from https://gist.github.com/underscorediscovery/81308642d0325fd386237cfa3b44785c
...
#define DECLARE_EVENT(EVT) struct EVT : public Event { static constexpr uint16_t uid = u32toEventType(hash_32_fnv1a_const(STRINGIFY(EVT))); EVT(); }
#define DEFINE_EVENT(EVT) EVT::EVT() : Event{uid} {}
