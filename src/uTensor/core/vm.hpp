...
class vm {
 public:
  template <typename T>
  void load_data(const char* filename, uint8_t unit_size, uint32_t cachesize,
                 uint32_t arrsize, long int offset, T* data);

  template <typename T>
  void flush_data(const char* filename, uint8_t unit_size, uint32_t cachesize,
                  uint32_t arrsize, long int offset, T* data);
...
template <typename U>
void vm::load_impl(U* dst, uint8_t unit_size, uint32_t offset,
                   uint32_t arrsize) {
...
template <typename T>
void vm::load_data(const char* filename, uint8_t unit_size, uint32_t cachesize,
                   uint32_t arrsize, long int offset, T* data) {
...
template <typename T>
void vm::flush_data(const char* filename, uint8_t unit_size, uint32_t cachesize,
                    uint32_t arrsize, long int offset, T* data) {
