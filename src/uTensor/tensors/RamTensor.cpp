...
RamTensor::RamTensor(TensorShape _shape, ttype _type) : TensorInterface(_shape, _type),
 _ram_region(Context::get_ram_data_allocator()->allocate(_shape.get_linear_size()*_type_size)) 
{
