...
SimpleErrorHandler::SimpleErrorHandler(size_t max_num_events)
...
void SimpleErrorHandler::set_onError(onErrorF_t onError) { _onError = onError; }
std::deque<Event>::iterator SimpleErrorHandler::begin() {
  return _eventQ.begin();
}
std::deque<Event>::iterator SimpleErrorHandler::end() { return _eventQ.end(); }
